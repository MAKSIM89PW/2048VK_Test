...
class ViewController: UIViewController {
    ...
    let maxValue: Int = GameConfiguration.maxValue
    ...
    private func setupViews(){
        ...
        board.anchor(top: nil,
                     ...
                     bottom: nil,
                     trailing: nil,
                     size: .init(width: board.frame.width, height: board.frame.height))
...
extension ViewController: GameLogicServiceDelegate {
    func showVictory() {
        ...
        let victoryImageView = UIImageView(image: UIImage(named: "Победа"))
